...
public class MessagePost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		out.println("	<img src='C:/Users/Jaymin/workspace/webtest/WebContent/lab3/images/bean.png' alt='Mr. Bean' class='img-circle img-responsive' />");
		out.println("	<input type='radio' name='image' value='bean.png' checked='true' />");
		out.println("</div>");

		out.println("<div class='col-md-2'>");
		out.println("	<img src='C:/Users/Jaymin/workspace/webtest/WebContent/lab3/images/clint.png' alt='Clint Eastwood' class='img-circle img-responsive' />");
		out.println("	<input type='radio' name='image' value='clint.png' />");
		out.println("</div>");

		out.println("<div class='col-md-2'>");
		out.println("	<img src='C:/Users/Jaymin/workspace/webtest/WebContent/lab3/images/gaga.png' alt='Lady Gaga' class='img-circle img-responsive' />");
		out.println("	<input type='radio' name='image' value='gaga.png' />");
		out.println("</div>");

		out.println("<div class='col-md-2'>");
		out.println("	<img src='C:/Users/Jaymin/workspace/webtest/WebContent/lab3/images/hermoine.png' alt='Hermoine G.' class='img-circle img-responsive''/>");
		...
		out.println("<div class='row text-center'>");
		out.println("<div class='col-md-offset-2 col-md-2'>");
		out.println("	<img src='C:/Users/Jaymin/workspace/webtest/WebContent/lab3/images/mj.png' alt='Michael Jackson' class='img-circle img-responsive'/>");
		out.println("	<input type='radio' name='image' value='mj.png' />");
		out.println("</div>");

		out.println("<div class='col-md-2'>");
		out.println("	<img src='C:/Users/Jaymin/workspace/webtest/WebContent/lab3/images/joker.png' alt='Joker' class='img-circle img-responsive'/>");
		out.println("	<input type='radio' name='image' value='joker.png' />");
		out.println("</div>");

		out.println("<div class='col-md-2'>");
		out.println("	<img src='C:/Users/Jaymin/workspace/webtest/WebContent/lab3/images/sheldon.png' alt='Sheldon' class='img-circle img-responsive'/>");
		out.println("	<input type='radio' name='image' value='sheldon.png' />");
		out.println("</div>");

		out.println("<div class='col-md-2'>");
		out.println("	<img src='C:/Users/Jaymin/workspace/webtest/WebContent/lab3/images/penny.png' alt='Penny' class='img-circle img-responsive' />");
	...
	protected void doPost(HttpServletRequest request,
		...
		String imagex = "C:/Users/Jaymin/workspace/webtest/WebContent/lab3/images/" + image;
