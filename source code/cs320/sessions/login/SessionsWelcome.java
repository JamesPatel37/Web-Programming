...
public class SessionsWelcome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ( session.getAttribute("SessionUser") == null ){
			...
			// Does a Remember Me cookie exist?
			//  If so, does it's value match the hash of
			//  any registered user?
			//  ??????
		...
		SessionsUser user = (SessionsUser) session.getAttribute("SessionUser");
