...
public class IntroToDatabases extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String port = "3306";
		String dbName = "cs320stu100";
		String username = "cs320stu100";
		String password = "!CefH.m8";
		...
		try{
			...
			if (request.getParameter("query") != null){
				...
				//query += "    OR last LIKE '%" + request.getParameter("query") + "%' ";
				//query += "    OR email LIKE '%" + request.getParameter("query") + "%' ";
			}
